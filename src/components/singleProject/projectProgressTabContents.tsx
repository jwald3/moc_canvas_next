        ...
        <div className="space-y-6 pb-8">
            ...
            {project?.steps?.map((step) => {
                ...
                return (
                    <div
                        key={step.id}
                        className="bg-gray-50 rounded-xl shadow-md border border-gray-200 overflow-hidden"
                    >
                        {/* Step Header - Always visible and clickable */}
                        <div 
                            className="p-6 border-b border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors bg-white"
                            ...
                            <div className="p-6 bg-gray-50">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                    {step.images.map((image, imageIndex) => (
                                        <div
                                            key={image.id}
                                            className="relative rounded-xl overflow-hidden bg-gray-100 group cursor-pointer shadow-sm"
