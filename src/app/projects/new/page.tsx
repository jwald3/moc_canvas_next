                            ...
                            <div className="p-6">
                                <ul className="space-y-3 text-sm text-indigo-800">
                                    <li className="flex items-start">
                                        ...
                                        <p>
                                            Organize your build into meaningful
                                            sections like "Engine Details" or
                                            "Custom Features"
                                        </p>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <p>
                                            Include close-up photos of special
                                            building techniques or modifications
                                            you've made
                                        </p>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <p>
                                            Use well-lit photos with clean
                                            backgrounds to make your creation
                                            stand out
                                        </p>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <p>
                                            Add descriptions that highlight what
                                            makes each section special or
                                            challenging
                                        </p>
                                    </li>
                                </ul>
