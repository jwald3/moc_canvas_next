                            ...
                            <div className="p-4 border-b border-gray-100">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">
                                            Track pieces and inventory for your
                                            build
                                        </p>
                                    </div>
                        ...
                        <div className="space-y-4 mb-6">
                            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                                ...
                                <p className="text-sm text-gray-700">
                                    Several small gray pieces (1x2 plates) were
                                    missing from the original kit. Found
                                    suitable replacements in the spare parts
                                    bin.
                                </p>
                            </div>
                            ...
                            <div className="bg-indigo-50 border-l-4 border-indigo-400 p-4 rounded-r-lg">
                                ...
                                <p className="text-sm text-gray-700">
                                    The instructions for the cockpit control
                                    panel can be a bit confusing. Make sure to
                                    orient the printed tiles correctly before
                                    attaching.
                                </p>
                            </div>
                        </div>
