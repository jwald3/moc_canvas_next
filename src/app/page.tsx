          ...
          <div className="flex justify-between items-center py-3">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/" className="flex items-center">
                ...
                <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-red-600">BrickTracker</span>
              </Link>
              
              {/* Desktop Nav */}
              <nav className="hidden md:flex space-x-6">
                <Link href="#featured" className="text-gray-700 hover:text-yellow-600 font-medium">Featured</Link>
                <Link href="#news" className="text-gray-700 hover:text-yellow-600 font-medium">News</Link>
                <Link href="#community" className="text-gray-700 hover:text-yellow-600 font-medium">Community</Link>
                <Link href="#themes" className="text-gray-700 hover:text-yellow-600 font-medium">Themes</Link>
              </nav>
            </div>
            
            {/* Search and User Actions */}
            <div className="flex items-center space-x-2 md:space-x-4">
              <div className={`relative transition-all duration-300 ${isSearchFocused ? 'w-60' : 'w-40'}`}>
                <input 
                  type="text" 
                  placeholder="Search builds..." 
                  className="w-full pl-8 pr-3 py-1.5 rounded-full border border-gray-300 focus:ring-2 focus:ring-yellow-400 focus:border-transparent"
              ...
              <button className="relative p-2 text-gray-600 hover:text-yellow-600 transition-colors">
                <Bell size={20} />
              ...
              <Link 
                href="/projects" 
                className="hidden md:block bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-4 py-1.5 rounded-full font-medium text-sm transition-all"
              >
                My Projects
              </Link>
              ...
              {/* Profile Image */}
              <div className="h-8 w-8 rounded-full bg-gray-200 overflow-hidden border-2 border-yellow-400 hidden md:block">
                <img src="/api/placeholder/32/32?text=Me" alt="Profile" className="h-full w-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 py-3 px-4 shadow-lg">
            <nav className="flex flex-col space-y-3">
              <Link href="#featured" className="text-gray-700 hover:text-yellow-600 font-medium py-1">Featured</Link>
              <Link href="#news" className="text-gray-700 hover:text-yellow-600 font-medium py-1">News</Link>
              <Link href="#community" className="text-gray-700 hover:text-yellow-600 font-medium py-1">Community</Link>
              <Link href="#themes" className="text-gray-700 hover:text-yellow-600 font-medium py-1">Themes</Link>
              <div className="border-t border-gray-100 pt-2">
                <Link 
                  href="/projects"
                  className="bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-4 py-2 rounded-full font-medium text-sm w-full block text-center"
                >
                  My Projects
                </Link>
              </div>
